...
class TagCreatorControler:
    ...
    def create(self, product_code: str) -> Dict:
        ...
        formatted_response = self.__format_responde(path_from_tag)

        return formatted_response

    def __create_tag(self, product_code: str) -> str:
        barcode_handler = BarcodeHandler()
        path_from_tag = barcode_handler.creta_barcode(product_code)

        return path_from_tag

    def __format_responde(self, path_from_tag: str) -> Dict:
        return { 
          "data": {
              "type": "Tag Image",
              "count": 1,
